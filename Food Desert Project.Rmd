...
models <- list(model.a, model.b, model.exhausitve, model.corr)
model.names <- c('model.a', 'model.b', 'model.exhaustive','model.corr')
...
### Multicollinearity
#vif(backwards_2)
new.models <- list(glm_food_int_Desert, glm_newfood_fac_Desert, emptyglm, fullglm, forwards_2, backwards_2)
new.models.name <- c('glm_food_int_Desert', 'glm_newfood_fac_Desert', 'emptyglm', 'fullglm', 'forwards_2', 'backwards_2')
aictab(cand.set = new.models, modnames = new.models.name)
...
food.trainLabels <- food[food_sample==1, 3]
food.testLabels <- food[food_sample==2, 3]
