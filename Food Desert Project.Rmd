...
The results above give us the top five models based on the criteria we selected. The next chapter will break down each model along with the models chosen from forwards selection to determine the best fit model from the AIC level. 
