...
Below you can see the ROC curve of the forwards_2 logisitic regression. The curve reflects the fact that we could not control for multicollinearity. 
```{r}
loadPkg("pROC")
loadPkg("caret")
