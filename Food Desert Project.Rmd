...
boxplot(OHU2010~Urban,data=food,main="Urban")
boxplot(NUMGQTRS~Urban,data=food,main="Urban")
boxplot(PovertyRate~Urban,data=food,main="Urban")
boxplot(MedianFamilyIncome~Urban,data=food,main="Urban")
boxplot(TractLOWI~Urban,data=food,main="Urban")
qqnorm(food$Urban,main="Urban")
qqnorm(food$POP2010, main="POP2010")
qqnorm(food$OHU2010, main="OHU2010")
```
...
my_data$State <- ordered(my_data$POP2010) 
                         levels = c("State", "Urban", "POP2010","OHU2010", "NUMGQTRS", "LILATracts_1And10]", "PovertyRate", "MedianFamilyIncome",
                                    "TractLOWI", "TractKids", "TractSenios", "TractWhite", "TractBlack", "TractAsian", "TractNHOPI", "TractAIAN", "TractOMultir","TractHispanic","TractHUNV","TractSNAP")
#library(dplyr)
...
res.aov_1 <- aov(Desert ~ Urban, data = food)
res.aov_2 <- aov(Desert ~ State, data = food)
res.aov_3 <- aov(Desert ~ Region, data = food)
res.aov_4 <- aov(Desert ~ OHU2010, data = food)
res.aov_5 <- aov(Desert ~ NUMGQTRS, data = food)
res.aov_6 <- aov(Desert ~ POP2010, data = food)
res.aov_7 <- aov(Desert ~ PovertyRate, data = food)
res.aov_8 <- aov(Desert ~ MedianFamilyIncome, data = food)
res.aov_9 <- aov(Desert ~ TractLOWI, data = food)
res.aov_10 <- aov(Desert ~ TractKids, data = food)
res.aov_11 <- aov(Desert ~ TractSeniors, data = food)
res.aov_12 <- aov(Desert ~ TractWhite, data = food)
res.aov_13 <- aov(Desert ~ TractBlack, data = food)
res.aov_14 <- aov(Desert ~ TractAsian, data = food)
res.aov_15 <- aov(Desert ~ TractNHOPI, data = food)
res.aov_16 <- aov(Desert ~ TractAIAN, data = food)
res.aov_17 <- aov(Desert ~ TractOMultir, data = food)
res.aov_18 <- aov(Desert ~ TractHispanic, data = food)
res.aov_19 <- aov(Desert ~ TractHUNV, data = food) 
```
