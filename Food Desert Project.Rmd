...
```
The results from sequential selection for the adjusted R-squared and Cp criterion gave us the same variables. So, we are only comparing adjusted R-squared with the BIC best fit model. 
